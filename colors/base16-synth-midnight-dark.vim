...
call <sid>hi("Error",         s:gui08, s:gui00, s:cterm08, s:cterm00, "reverse", "")
call <sid>hi("ErrorMsg",      s:gui08, s:gui00, s:cterm08, s:cterm00, "reverse", "")
...
call <sid>hi("ErrorHighlight",   s:gui08, s:gui00, s:cterm08, s:cterm00, "underline,reverse", s:gui08)
call <sid>hi("WarningHighlight", s:gui09, s:gui00, s:cterm09, s:cterm00, "underline,reverse", s:gui09)
call <sid>hi("InfoHighlight",    s:gui0D, s:gui00, s:cterm0D, s:cterm00, "underline,reverse", s:gui0D)
call <sid>hi("HintHighlight",    s:gui0C, s:gui00, s:cterm0C, s:cterm00, "underline,reverse", s:gui0C)

call <sid>hi("SpellBad",     "", "", s:cterm08, s:cterm00, "undercurl,reverse", s:gui08)
call <sid>hi("SpellLocal",   "", "", s:cterm0C, s:cterm00, "undercurl,reverse", s:gui0C)
call <sid>hi("SpellCap",     "", "", s:cterm0D, s:cterm00, "undercurl,reverse", s:gui0D)
call <sid>hi("SpellRare",    "", "", s:cterm0E, s:cterm00, "undercurl,reverse", s:gui0E)
